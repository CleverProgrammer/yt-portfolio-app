...
MyHeroUnit.schema = {
  ...
  getDefaultProps: () => ({
    ...
    text: "We are Clever Programmers 🚀. We are a hi-tech web development company committed to deliver great products on time. We love to understand our customers' needs and exceed expectations.",
  }),
  sideEditProps: [
    {
      name: 'padding',
